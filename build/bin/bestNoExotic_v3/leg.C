...
//=========  (Tue Jun 25 17:17:42 2024) by ROOT version 6.18/00
   ...
   entry=leg->AddEntry("m_Kpipiweight_2","#it{B}#rightarrow#it{#psi(2S)}#it{[K^{*}(1410)/K^{*}(1680)]}","f");
   entry->SetFillStyle(1001);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("m_Kpipiweight_3","#it{B}#rightarrow#it{#psi(2S)}#it{K(1460)}","f");
   entry->SetFillStyle(1001);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("m_Kpipiweight_4","#it{B}#rightarrow#it{#psi(2S)}#it{[K_{2}^{*}(1430)/K_{2}(1770)]}","f");
   entry->SetFillStyle(1001);

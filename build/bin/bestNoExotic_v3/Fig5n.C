...
//=========  (Wed Jul 10 13:00:06 2024) by ROOT version 6.32.02
   ...
   TLegendEntry *entry=leg->AddEntry("m_Kpipiweight_5","#it{B}^{+}#rightarrow[#it{#psi}(4360)/#it{#psi}(4415)/#it{#psi}(4660)] #it{K}^{+}","f");

...
//=========  (Wed Jul 10 15:06:37 2024) by ROOT version 6.32.02
   ...
   Double_t Graph0_fx1[40] = { 0, 0.3202563, 0.4529108, 0.5547002, 0.6405126, 0.7161149, 0.7844645, 0.8473185, 0.9058216, 0.9607689, 1.012739, 1.06217, 1.1094, 1.154701, 1.198289, 1.240347, 1.281025,
   ...
   Double_t Graph0_fy1[40] = { 0, 0, 0, 0, 0, 0, 7.663856e-08, 2.692931e-05, 0.0002140915, 0.0009378543, 0.004216748, 0.0169114, 0.02972601, 0.04204034, 0.05681312, 0.07812016, 0.1085612,
   0.1433415, 0.1769023, 0.20782, 0.2364126, 0.263331, 0.2892212, 0.3146646, 0.3401603, 0.366106, 0.3927848, 0.4203725, 0.4489627, 0.4785964, 0.5092912, 0.5410683, 0.5739831,
   0.6081634, 0.643864, 0.6815255, 0.7217482, 0.7649172, 0.8104675, 0.8564874 };
   ...
   Graph_Graph01->GetYaxis()->SetTitle(" #Gamma(#it{s}) [GeV]");
   ...
   pt->SetTextFont(132);
   pt->SetTextSize(0.08);
   TText *pt_LaTex = pt->AddText("#it{K}_{1}(1270)^{+}");
   pt->Draw();
   c1->Modified();
   c1->SetSelected(c1);
}

...
//=========  (Tue Jun 25 17:14:09 2024) by ROOT version 6.18/00
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("m_Kpipiweight_4","#it{B#rightarrowT_{c#bar{c}} #[]{K#pi}}","f");
   entry->SetFillStyle(1001);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("m_Kpipiweight_5","#it{B#rightarrowT_{c#bar{c}#bar{s}} #[]{#pi#pi}}","f");
   entry->SetFillStyle(1001);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("m_Kpipiweight_6","#it{B#rightarrowT_{c#bar{c}#bar{s}} #pi}","f");
   entry->SetFillStyle(1001);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("m_Kpipiweight_bkg","Background","f");

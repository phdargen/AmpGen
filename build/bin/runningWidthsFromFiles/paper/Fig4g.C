...
//=========  (Wed Jul 10 15:02:27 2024) by ROOT version 6.32.02
   ...
   Double_t Graph0_fx6[40] = { 0, 0.3202563, 0.4529108, 0.5547002, 0.6405126, 0.7161149, 0.7844645, 0.8473185, 0.9058216, 0.9607689, 1.012739, 1.06217, 1.1094, 1.154701, 1.198289, 1.240347, 1.281025,
   ...
   Double_t Graph0_fy6[40] = { 0, 0, 0, 0, 0, 0, 6.725847e-05, 0.002521044, 0.007451535, 0.0138996, 0.02128643, 0.02925038, 0.03755889, 0.04605893, 0.05464807, 0.0632569, 0.07183804,
   0.08035912, 0.08879813, 0.09714032, 0.1053761, 0.1134995, 0.1215072, 0.1293978, 0.1371712, 0.1448283, 0.1523707, 0.1598005, 0.1671201, 0.1743321, 0.1814393, 0.1884445, 0.1953506,
   0.2021603, 0.2088766, 0.2155022, 0.2220397, 0.2284919, 0.2348612, 0.24115 };
   ...
   Graph_Graph06->SetDirectory(nullptr);
   ...
   Graph_Graph06->GetYaxis()->SetTitle(" #Gamma(#it{s}) [GeV]");
   ...
   pt->SetTextFont(132);
   pt->SetTextSize(0.08);
   TText *pt_LaTex = pt->AddText("#it{K}_{2}(1770)^{+}");
   pt->Draw();
   c1_n6->Modified();

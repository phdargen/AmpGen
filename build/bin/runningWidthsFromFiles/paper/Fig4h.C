...
//=========  (Wed Jul 10 15:06:41 2024) by ROOT version 6.32.02
   ...
   Double_t Graph0_fx8[40] = { 4, 4.063597, 4.126214, 4.187895, 4.24868, 4.308608, 4.367714, 4.42603, 4.483588, 4.540417, 4.596543, 4.651992, 4.706787, 4.760952, 4.814508, 4.867474, 4.919871,
   4.971715, 5.023024, 5.073814, 5.124101, 5.173899, 5.223222, 5.272084, 5.320497, 5.368474, 5.416026, 5.463163, 5.509898, 5.556239, 5.602197, 5.647782, 5.693001,
   5.737863, 5.782378, 5.826553, 5.870395, 5.913912, 5.957112, 6 };
   Double_t Graph0_fy8[40] = { 0, 0, 0, 0, 0, 0, 0.0003332904, 0.001664266, 0.004031093, 0.007436512, 0.01187044, 0.01731347, 0.02374014, 0.0311206, 0.03942239, 0.04861133, 0.0586524,
   0.06951035, 0.08115006, 0.09353701, 0.1066373, 0.120418, 0.1348472, 0.1498941, 0.1655289, 0.1817232, 0.1984494, 0.2156816, 0.2333945, 0.2515642, 0.2701677, 0.2891834, 0.3085901,
   0.3283682, 0.3484986, 0.3689634, 0.3897451, 0.4108277, 0.4321953, 0.4534511 };
   ...
   pt->SetTextFont(132);
   pt->SetTextSize(0.08);
   TText *pt_LaTex = pt->AddText("#it{T}_{#it{c#bar{c}#bar{s}}}^{0}#rightarrow#it{#psi}(2#it{S})#it{K}^{+}#it{#pi}^{#minus}");
   pt->Draw();
   c1_n8->Modified();

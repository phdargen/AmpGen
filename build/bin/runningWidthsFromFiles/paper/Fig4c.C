...
//=========  (Wed Jul 10 15:06:38 2024) by ROOT version 6.32.02
   ...
   Double_t Graph0_fx3[40] = { 0, 0.3202563, 0.4529108, 0.5547002, 0.6405126, 0.7161149, 0.7844645, 0.8473185, 0.9058216, 0.9607689, 1.012739, 1.06217, 1.1094, 1.154701, 1.198289, 1.240347, 1.281025,
   ...
   Double_t Graph0_fy3[40] = { 0, 0, 0, 0, 3.851992e-05, 0.0008210656, 0.001990965, 0.003306941, 0.004686378, 0.006177104, 0.008215306, 0.01375264, 0.02626542, 0.04452328, 0.06722408, 0.09346171, 0.1224675,
   0.1531851, 0.1846671, 0.2163648, 0.2479462, 0.2791833, 0.3099123, 0.3400157, 0.369411, 0.3980432, 0.4258786, 0.4528991, 0.4790994, 0.5044832, 0.5290613, 0.5528494, 0.5758669,
   0.5981358, 0.6196796, 0.6405229, 0.6606906, 0.680208, 0.6990998, 0.7172152 };
   ...
   Graph_Graph03->GetYaxis()->SetTitle(" #Gamma(#it{s}) [GeV]");
   ...
   pt->SetTextFont(132);
   pt->SetTextSize(0.08);
   TText *pt_LaTex = pt->AddText("#it{K}^{*}(1410)^{+}");
   pt->Draw();
   c1_n3->Modified();

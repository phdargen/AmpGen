...
//=========  (Wed Jul 10 15:02:25 2024) by ROOT version 6.32.02
   ...
   Double_t Graph0_fx2[40] = { 0, 0.3202563, 0.4529108, 0.5547002, 0.6405126, 0.7161149, 0.7844645, 0.8473185, 0.9058216, 0.9607689, 1.012739, 1.06217, 1.1094, 1.154701, 1.198289, 1.240347, 1.281025,
   ...
   Double_t Graph0_fy2[40] = { 0, 0, 0, 0, 0, 0, 1.852055e-07, 1.020572e-05, 5.45448e-05, 0.0002177844, 0.0008855009, 0.004525432, 0.01403405, 0.02838084, 0.04646403, 0.06749462, 0.09125773,
   0.1169242, 0.1428769, 0.1689879, 0.1950406, 0.2208696, 0.2463538, 0.2714084, 0.2959787, 0.3200348, 0.3435676, 0.3665851, 0.3891094, 0.4111733, 0.4328157, 0.4540742, 0.4749751,
   0.495524, 0.5156998, 0.5354594, 0.5547506, 0.573526, 0.5917525, 0.6092438 };
   ...
   Graph_Graph02->GetYaxis()->SetTitle(" #Gamma(#it{s}) [GeV]");
   ...
   pt->SetTextFont(132);
   pt->SetTextSize(0.08);
   TText *pt_LaTex = pt->AddText("#it{K}_{1}(1400)^{+}");
   pt->Draw();
   c1_n2->Modified();

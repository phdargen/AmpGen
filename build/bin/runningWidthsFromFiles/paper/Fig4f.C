...
//=========  (Wed Jul 10 15:02:27 2024) by ROOT version 6.32.02
   ...
   Double_t Graph0_fx5[40] = { 0, 0.3202563, 0.4529108, 0.5547002, 0.6405126, 0.7161149, 0.7844645, 0.8473185, 0.9058216, 0.9607689, 1.012739, 1.06217, 1.1094, 1.154701, 1.198289, 1.240347, 1.281025,
   1.320451, 1.358732, 1.395965, 1.43223, 1.467599, 1.502135, 1.535895, 1.568929, 1.601282, 1.632993, 1.664101, 1.694637, 1.724633, 1.754116, 1.783112, 1.811643,
   1.839732, 1.867399, 1.894662, 1.921538, 1.948043, 1.974192, 2 };
   Double_t Graph0_fy5[40] = { 0, 0, 0, 0, 0.0002164321, 0.004613326, 0.01118664, 0.01857153, 0.02618888, 0.03378679, 0.04135452, 0.04950227, 0.05906538, 0.07012558, 0.08315176, 0.09933756, 0.1194183,
   0.1412464, 0.1624176, 0.1822147, 0.2006371, 0.217828, 0.2339333, 0.2490767, 0.2633599, 0.2768673, 0.2896695, 0.3018267, 0.3133908, 0.3244075, 0.3349171, 0.3449554, 0.3545546,
   0.3637439, 0.3725496, 0.380996, 0.3891048, 0.3968965, 0.4043895, 0.4115319 };
   ...
   Graph_Graph05->SetDirectory(nullptr);
   ...
   Graph_Graph05->GetYaxis()->SetTitle(" #Gamma(#it{s}) [GeV]");
   ...
   pt->SetTextFont(132);
   pt->SetTextSize(0.08);
   TText *pt_LaTex = pt->AddText("#it{K}^{*}(1680)^{+}");
   pt->Draw();
   c1_n5->Modified();

...
//=========  (Wed Jul 10 15:02:26 2024) by ROOT version 6.32.02
   ...
   Double_t Graph0_fx4[40] = { 0, 0.3202563, 0.4529108, 0.5547002, 0.6405126, 0.7161149, 0.7844645, 0.8473185, 0.9058216, 0.9607689, 1.012739, 1.06217, 1.1094, 1.154701, 1.198289, 1.240347, 1.281025,
   ...
   Double_t Graph0_fy4[40] = { 0, 0, 0, 0, 5.716151e-07, 0.000106181, 0.0005236566, 0.001364172, 0.002704571, 0.004663605, 0.007875402, 0.01540341, 0.02333639, 0.03065264, 0.0380873, 0.04655984, 0.0562557,
   0.06685487, 0.07802283, 0.08963942, 0.1016795, 0.1141318, 0.1269807, 0.1402052, 0.1537801, 0.1676782, 0.1818708, 0.1963293, 0.2110253, 0.2259311, 0.24102, 0.2562666, 0.2716467,
   0.2871373, 0.3027169, 0.3183653, 0.3340635, 0.349794, 0.3655404, 0.381134 };
   ...
   Graph_Graph04->GetYaxis()->SetTitle(" #Gamma(#it{s}) [GeV]");
   ...
   pt->SetTextFont(132);
   pt->SetTextSize(0.08);
   TText *pt_LaTex = pt->AddText("#it{K}_{2}^{*}(1430)^{+}");
   pt->Draw();
   c1_n4->Modified();
